...
\newcommand{\projectscreenshot}[2]{%
    \begin{figure}[htbp]
        ...
        \IfFileExists{../../docs/images/#1.png}{%
            \includegraphics[width=0.8\textwidth]{../../docs/images/#1.png}%
        }{%
            \IfFileExists{../../docs/images/#1.jpg}{%
                \includegraphics[width=0.8\textwidth]{../../docs/images/#1.jpg}%
            }{%
                \IfFileExists{../../docs/images/#1.jpeg}{%
                    \includegraphics[width=0.8\textwidth]{../../docs/images/#1.jpeg}%
                }{%
                    \fbox{\parbox{0.8\textwidth}{\centering Скриншот не найден по пути \texttt{docs/images/#1.(png|jpg|jpeg)}}}%
                }%
            }%
        }%
        \caption{#2}
...
\section*{Приложение А. Скриншоты мобильного интерфейса}
\addcontentsline{toc}{section}{Приложение А. Скриншоты мобильного интерфейса}

Ниже размещены ключевые экраны Android-клиента. Отчёт настроен на автоматический поиск изображений в каталоге \texttt{docs/images} по ожидаемым именам файлов.

\projectscreenshot{профиль}{Экран профиля пользователя}
\projectscreenshot{акции сбербанка}{Экран карточки акции Сбербанка}
\projectscreenshot{список акций}{Экран списка акций}
\projectscreenshot{статистика портфеля}{Экран статистики портфеля}
