...
На 8 апреля 2026 года основной baseline проекта задаёт `origin/main`, а ветка `feature/mobile-frontend` продолжает хранить импортированный Android-клиент поверх более раннего среза проекта.
...
- `origin/main` впереди на 4 коммита
...
- `origin/main` впереди на 8 коммитов
